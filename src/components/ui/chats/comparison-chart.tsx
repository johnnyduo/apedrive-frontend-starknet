...
export default function ComparisonChart() {
  ...
  const formattedDate = format(new Date(date), 'MMMM d, yyyy hh:mma');
        ...
        <div>
          <div className="text-sm uppercase tracking-wider sm:text-base">
            <span className="flex items-center gap-2.5">
              ...
              >
                <Cardano className="h-auto w-7 lg:w-9" />
          ...
          <div className="mt-5 flex items-end gap-3 text-base font-medium text-gray-900 dark:text-white sm:text-xl lg:flex-wrap 2xl:flex-nowrap">
            <span className="text-2xl font-semibold xl:text-4xl">
              {parseFloat((sensorData.s / 1000).toFixed(4)).toLocaleString(
                'en-US'
              )}
            </span>
            <span
