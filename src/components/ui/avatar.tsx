...
const sizes: Record<SizeNames, string[]> = {
  xl2: [
    'border-white border-[5px] h-32 w-32 sm:h-35 sm:w-35 md:h-56 md:w-56 3xl:h-70 3xl:w-70 3xl:border-11 shadow-large',
  ],
  // xl2: [
  //   'border-white border-[5px] h-42 w-42 sm:h-49 sm:w-49 md:h-56 md:w-56 3xl:h-70 3xl:w-70 3xl:border-11 shadow-large',
  // ]
  xl: [
    'border-white border-[5px] h-24 w-24 sm:h-28 sm:w-28 md:h-32 md:w-32 3xl:h-40 3xl:w-40 3xl:border-8 shadow-large',
  ],
  lg: ['border-whiteborder-4 h-20 w-20 lg:h-24 lg:w-24'],
