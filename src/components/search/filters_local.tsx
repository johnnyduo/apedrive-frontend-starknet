...
import CollectionSelectLocal from '@/components/ui/collection-select-list-local';
...
export function LocalFilters() {
  return (
    <>
      ...
      <Collapse label="Local Types" initialOpen>
        <CollectionSelectLocal onSelect={(value) => console.log(value)} />
      </Collapse>
    </>
  );
}
